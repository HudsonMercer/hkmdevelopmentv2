        ...
        >
          <section className="paneContentAllGrid">
            ...
            <p>
              ...
              HTMLJSCSS, and a few other common industry build tools and
              utilites.
            </p>
            <p>
            ...
            <p>
              At this point in time I am looking an environment that will test
              my design, coding and learning abilities. My primary interest is
              in UX/UI design and implementation, although I am always up for a
              new challenge. Constantly I find myself doing what I once thought
              impossible.
            </p>
          </section>
        </PaneContent>
