...
export default class PaneProjects extends Component {
  render() {
    return ( <SidePane rotationHome={-86} animationSpeed={0.75} bobbleSpeed={2} lable="Projects" className="projectsPane contentPane">
      <PaneContentGallery>
        ...
        <PaneContent className="paneContentProjectsColor" headerText="Tic Tac Toe - React">
          <div>
            ...
            <p>
              This version of the Tic Tac Toe demonstration takes a more modern "app" approach. It fully implements real-time multiplayer via Google's platform, state management with Redux and front end interaction with Facebook's React framework.
            </p>
            <p>
        ...
        <PaneContent className="paneContentProjectsColor" headerText="HKM - Dev V1.0">
          <div>
            ...
            <p>This version of this site was scraped due not feeling happy with the design. It gave a far more static and monolithic feel than what I had originally intended.</p>
          </div>
          <IconBar>
            <Icon image={reactImg} link="https://reactjs.org/"/>
